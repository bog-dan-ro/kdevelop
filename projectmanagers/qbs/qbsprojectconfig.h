...
public:
    explicit QbsProjectConfig(const qbs::SetupProjectParameters &setupProjectParameters, QWidget *parent = 0);
    ~QbsProjectConfig();
    const qbs::SetupProjectParameters &setupProjectParameters() const { return m_setupProjectParameters; }
